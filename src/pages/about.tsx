    ...
    <Row center="xs">
      ...
      <StyledCol xs={12} md={6}>
        <DropdownCard title="Passionate Developer">
          I <b>love</b> javascript especially typescript. I&apos;m passionate about React and everything that has to do
          with css-in-js e.g. styled-components. Currently I&apos;m learning the ins and outs of Golang and am very
